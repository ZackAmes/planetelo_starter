...
declare const setupBurnerManager: (config: DojoConfig) => Promise<BurnerManager>;

export { type Burner, type BurnerAccount, BurnerConnector, BurnerContext, type BurnerCreateOptions, type BurnerKeys, BurnerManager, type BurnerManagerOptions, BurnerProvider, type BurnerProviderProps, type BurnerRecord, type BurnerStorage, DojoBurnerStarknetWindowObject, DojoPredeployedStarknetWindowObject, type Predeployed, type PredeployedAccount, PredeployedManager, type PredeployedManagerOptions, type PredeployedStorage, katanaIcon, prefundAccount, setupBurnerManager, useBurner, useBurnerManager, useBurnerWindowObject, usePredeployedWindowObject };
