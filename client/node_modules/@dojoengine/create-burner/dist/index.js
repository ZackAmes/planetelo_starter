...
// src/manager/setupBurnerManager.ts
import { Account as Account4, RpcProvider as RpcProvider3 } from "starknet";
var setupBurnerManager = async (config) => {
  const burnerManager = new BurnerManager({
    masterAccount: new Account4(
      {
    ...
    rpcProvider: new RpcProvider3({ nodeUrl: config.rpcUrl }),
