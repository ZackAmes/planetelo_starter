 ...
 */
declare function setComponentsFromEvents(components: Components, events: any[]): void;
/**
 ...
 */
declare function getComponentNameFromEvent(actions: string[], event: string[]): string;
declare function getSelectorFromTag(namespace: string, event: string): string;
declare function computeByteArrayHash(str: string): bigint;
declare function splitEventTag(event: string): string[];
/**
...
export { computeByteArrayHash, decodeComponent, getComponentNameFromEvent, getEntityIdFromKeys, getEvents, getSelectorFromTag, hexToAscii, parseComponentValue, parseComponentValueFromGraphQLEntity, recursiveSNoise, setComponentFromEvent, setComponentFromGraphQLEntity, setComponentsFromEvents, setComponentsFromGraphQLEntities, shortenHex, snoise, splitEventTag };
